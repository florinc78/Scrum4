...
public class UserRestController {
	...
	@RequestMapping(value = "/rest/user/{param}", method = RequestMethod.GET, produces={"application/json"},headers = {"Accept=text/xml, application/json"})
	public @ResponseBody Object  getData(@PathVariable String param
		...
		dataTable = appUserDao.getPage(pageData);
